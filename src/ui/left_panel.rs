            ...
            if !app.workspace_layout.left_panel_collapsed {
                egui::ScrollArea::vertical()
                    ...
                    .show(ui, |ui| {
                        ui.vertical(|ui| {
                            // === TOOLS / BRUSH PRESETS ===
                            panel_section(ui, "TOOLS / BRUSH PRESETS", |ui| {
                            ...
                            // === BRUSH SETTINGS (always visible, content conditional on active tool) ===
                            panel_section(ui, "BRUSH SETTINGS", |ui| {
                            if matches!(app.active_tool, ToolId::Brush | ToolId::Eraser) {
                                ...
                                ui.horizontal(|ui| {
                                    ...
                                    for (idx, &(icon, _name, _)) in tip_types.iter().enumerate() {
                                        ...
                                        if ui.add_sized([24.0, 22.0], btn).on_hover_text(tip_names[idx]).clicked() {
                                            // Change hardness based on tip selection
                                            match idx {
                                ...
                                egui::collapsing_header::CollapsingState::load_with_default_open(
                                    ...
                                    // Ver1 Prs Spec (placeholder)
                                    ui.add_enabled(false, egui::Checkbox::new(&mut false, "Ver1 Prs Spec"));
                                    // Anti-Ripple (stabilizer smooth, enabled by default)
                                ...
                                egui::collapsing_header::CollapsingState::load_with_default_open(
                                    ...
                                    // Curve Interp checkbox
                                    ui.checkbox(&mut false, "Curve Interp.");

                                    // Pressure-to-size mapping sliders
                                ...
                                egui::collapsing_header::CollapsingState::load_with_default_open(
                                    ...
                                    ui.horizontal(|ui| {
                                        ...
                                        if ui.add(egui::DragValue::new(&mut app.pressure_curve).speed(0.05)).changed() {
                                            // pressure_curve is used in canvas rendering
                                        }
                                        ui.label("curve");
                                    });
                                    // Min Pressure
                            ...
                            }); // panel_section BRUSH SETTINGS

                            ui.add_space(2.0);

                            // === TOOL OPTIONS (dynamic, non-brush) ===
                            panel_section(ui, "TOOL OPTIONS", |ui| {
