        ...
        egui::TopBottomPanel::top("quick_bar").show(ctx, |ui| {
            ui.horizontal(|ui| {
                ...
                if ui.button("Transform").clicked() {
                    app.command(CommandId::ToolTransform);
                }
                ui.separator();
                ...
                if ui.button("Copy").clicked() {
                    app.command(CommandId::Copy);
                }
                if ui.button("Paste").clicked() {
                    app.command(CommandId::Paste);
                }
                ...
                let zoom_changed = egui::ComboBox::from_id_source("quick_zoom")
                    ...
                    .show_ui(ui, |ui| {
                        ...
                        if ui.selectable_label(zoom_pct == 25.0, "25%").clicked() {
                            app.viewport_zoom = 0.25;
                            changed = true;
                        }
                        if ui.selectable_label(zoom_pct == 50.0, "50%").clicked() {
                            app.viewport_zoom = 0.50;
                            changed = true;
                        }
                        if ui.selectable_label(zoom_pct == 75.0, "75%").clicked() {
                            app.viewport_zoom = 0.75;
                            changed = true;
                        }
                        if ui.selectable_label(zoom_pct == 100.0, "100%").clicked() {
                            app.viewport_zoom = 1.0;
                            changed = true;
                        }
                        if ui.selectable_label(zoom_pct == 150.0, "150%").clicked() {
                            app.viewport_zoom = 1.50;
                            changed = true;
                        }
                        if ui.selectable_label(zoom_pct == 200.0, "200%").clicked() {
                            app.viewport_zoom = 2.00;
                            changed = true;
                        }
                        if ui.selectable_label(zoom_pct == 300.0, "300%").clicked() {
                            app.viewport_zoom = 3.00;
                            changed = true;
                        }
                        if ui.selectable_label(zoom_pct == 400.0, "400%").clicked() {
                            app.viewport_zoom = 4.00;
                            changed = true;
                        }
                        if ui.selectable_label(zoom_pct == 800.0, "800%").clicked() {
                            app.viewport_zoom = 8.00;
                            changed = true;
                        }
                        changed
                    })
                ...
                if ui.button("-15°").clicked() {
                    app.rotation_angle = (app.rotation_angle - 15.0f32.to_radians())
                        .rem_euclid(2.0 * std::f32::consts::PI);
                }
                let rot_text = format!("{:.0}°", app.rotation_angle.to_degrees());
                if ui
                    .button(rot_text)
                    .on_hover_text("Click to reset rotation to 0°")
                    .clicked()
                {
                ...
                let mirror_label = if app.mirror_horizontal {
                    "Mirror: On"
                } else {
                    "Mirror: Off"
                };
                ...
                let stab_changed = egui::ComboBox::from_id_source("quick_bar_stab")
                    ...
                    .show_ui(ui, |ui| {
                        ...
                        for val in 1..=15 {
                            let is_sel =
                                matches!(current_level, StabilizerLevel::Level(v) if v == val);
                        ...
                        for val in 1..=5 {
                            let is_sel =
                                matches!(current_level, StabilizerLevel::SLevel(v) if v == val);
                ...
                let mode_changed = egui::ComboBox::from_id_source("quick_bar_stab_mode")
                    ...
                    .show_ui(ui, |ui| {
                        ...
                        if ui
                            .selectable_label(
                                current_mode == crate::input::StabilizerMode::Ema,
                                "EMA",
                            )
                            .clicked()
                        {
                        ...
                        if ui
                            .selectable_label(
                                current_mode == crate::input::StabilizerMode::SpringMassDamper,
                                "Spring Physics",
                            )
                            .clicked()
                        {
